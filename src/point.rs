...
pub type Point2D<T> = TypedPoint2D<T, Untyped>;
...
impl<T: Clone, U> TypedPoint2D<T, U> {
    pub fn from_typed(x: Length<T, U>, y: Length<T, U>) -> TypedPoint2D<T, U> {
...
impl<T: Clone, U> TypedPoint3D<T, U> {
    pub fn from_typed(x: Length<T, U>, y: Length<T, U>, z: Length<T, U>) -> TypedPoint3D<T, U> {
...
pub type Point4D<T> = TypedPoint4D<T, Untyped>;
...
impl<T: Clone, U> TypedPoint4D<T, U> {
    pub fn from_typed(x: Length<T, U>,
                      y: Length<T, U>,
                      z: Length<T, U>,
